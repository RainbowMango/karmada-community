...
The Karmada User Group (KUG) is a community effort to create a friendly and active space for people who use the Karmada
...
The main goals of the Karmada User Group are:
...
The Karmada User Group is open to **end users** and **vendors** who are currently using Karmada in production. 
This includes:
...
To join the Karmada User Group, follow these steps based on whether you are the first person from your company or an 
additional member:

#### For the First Developer from Your Company

If you are the first developer from your company to join the Karmada User Group, please provide the following information:
...
3. **Review and Onboarding**:
   ...
   - If everything looks good, the following onboarding steps will be initiated:
      - **Update User Group List**: Add your company to the list of Karmada User Group.
      ...
      - And so on.
   - Once all onboarding steps are completed, your company will be officially listed as part of the Karmada User Group,
     and you will receive invitations to join the relevant teams and groups.

#### For Additional Developers from an Existing Company

If your company is already part of the Karmada User Group and you are an additional developer who wants to join, follow
these simplified steps:

1. **Open an Issue**:
   - Go to the [karmada-io/community](https://github.com/karmada-io/community) repository on GitHub.
   - Open a [new issue with the template](TBD), titled "Add Developer to Karmada User Group", and include:
...
By joining the Karmada User Group, you will enjoy several benefits, including:

- **Visibility for Your Company**: Your company's profile will be featured on the list of [Karmada User Group](TBD), increasing visibility within the community.
...
The Karmada User Group has a dedicated GitHub team specifically for verified members. This team is part of the 
...
- **Permissions**: Members of this team have read-only access to the Karmada repositories and can participate in discussions and issues related to the user group.
- **Invitation**: Once your application is approved, you will receive an invitation to join the team via GitHub.

## Mail Group

We maintain a dedicated Google Mail Group for the Karmada User Group. This mail group is used for important 
announcements, updates, and information sharing. Only verified members of the Karmada User Group are added to this mail 
group.
...
Currently, there is no formal process for leaving the Karmada User Group. However, the Karmada maintainer team reserves 
the right to remove members if they violate community guidelines or fail to follow the principles of the group.

## Usage of User Group Information

1. **Public Sharing**:
  After joining the Karmada User Group, the company name, company logo, and public use cases may be shared by the 
...
2. **Prohibition of Commercial Use**:
  All information related to the Karmada User Group (including company names, logos, use cases, etc.) is intended for 
...
5. **Adherence to Community Guidelines**:
  As a member of the Karmada User Group, you are expected to adhere to the community's code of conduct and guidelines. Respect the rights and opinions of other members and actively participate in healthy discussions and collaborations.

## Contact Information

For any questions or assistance regarding the Karmada User Group, please contact the following channels:
